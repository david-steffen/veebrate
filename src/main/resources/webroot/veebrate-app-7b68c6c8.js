 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const V=new class{handleAttributeExpressions(e,t,s,i){const n=t[0];if("."===n){return new N(e,t.slice(1),s).parts}return"@"===n?[new w(e,t.slice(1),i.eventContext)]:"?"===n?[new x(e,t.slice(1),s)]:new b(e,t,s).parts}handleTextExpression(e){return new S(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
//# sourceMappingURL=veebrate-app-7b68c6c8.js.map
