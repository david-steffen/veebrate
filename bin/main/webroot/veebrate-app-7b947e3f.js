 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const V=new class{handleAttributeExpressions(e,t,s,n){const i=t[0];if("."===i){return new N(e,t.slice(1),s).parts}return"@"===i?[new w(e,t.slice(1),n.eventContext)]:"?"===i?[new x(e,t.slice(1),s)]:new b(e,t,s).parts}handleTextExpression(e){return new S(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
